...
var Comments = function (_Component) {
  ...
  _createClass(Comments, [{
    ...
    value: function onSubmit(e) {
      ...
      var newListArray = Object.assign([], this.state.list);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'form-control', onChange: this.onChange.bind(this), type: 'text', name: 'username', placeholder: 'username' }),
            _react2.default.createElement('br', null),
            _react2.default.createElement('input', { className: 'form-control', onChange: this.onChange.bind(this), type: 'text', name: 'body', placeholder: 'Comment' }),
            _react2.default.createElement('br', null),
            _react2.default.createElement(
              'button',
  ...
  _createClass(Zones, [{
    ...
    value: function componentDidMount() {
      ...
      _superagent2.default.get('/api/zone').query(null).set('Accept', 'application/json').end(function (err, response) {
        ...
        var results = response.body.results;
        var zone = Object.assign({}, _this2.state.zone);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.onSubmit.bind(this) },
          _react2.default.createElement('input', { type: 'text', className: 'form-control', onChange: this.onChange.bind(this), id: 'name', placeholder: 'Name' }),
          _react2.default.createElement('br', null),
          _react2.default.createElement('input', { type: 'text', className: 'form-control', onChange: this.onChange.bind(this), id: 'zipCode', placeholder: 'Zip Code' }),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            'button',
  ...
  _createClass(Comment, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { style: style.commentWeight },
          this.props.currentComment.username
        ),
        _react2.default.createElement(
          'span',
          { style: style.seprator },
          '|'
        ),
        _react2.default.createElement(
          'span',
